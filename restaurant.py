...
lblcopyright = Label(Bottoms, font=('arial', 10, 'italic'), text="Created by ANKRETON INDUSTIES", bd=0, anchor='w')
...
#=============================Functions==================
def tPrice():
    cBprice=int(costdosa.get())
    bBprice=int(costidli.get())
    fFprice=int(costvada.get())
    sDprice=int(costsoftDrinks.get())
    cDprice=int(costchutney.get())

    cBno=int(dosa.get())
    bBno=int(idli.get())
    fFno=int(vada.get())
    sDno=int(softDrinks.get())
    cTno=int(chutney.get())
    tempVat=int(vat.get())
    subPrice=(cBprice*cBno+bBprice*bBno+fFprice*fFno+sDprice*sDno+cDprice*cTno)
...
# --------------
lblCb=Label(f1aa,font=('arial',16,'bold'),text="dosa", bd=16, justify='left')
lblCb.grid(row=1,column=0)
txtCb=Entry(f1aa,font=('arial',16,'bold'),textvariable=dosa, bd=10,insertwidth=2, justify='left')
txtCb.grid(row=1,column=1)
# --------------
lblBb=Label(f1aa,font=('arial',16,'bold'),text="idli", bd=16, justify='left')
lblBb.grid(row=2,column=0)
txtBb=Entry(f1aa,font=('arial',16,'bold'),textvariable=idli, bd=10,insertwidth=2, justify='left')
txtBb.grid(row=2,column=1)
# --------------
lblFf=Label(f1aa,font=('arial',16,'bold'),text="vada", bd=16, justify='left')
lblFf.grid(row=3,column=0)
txtFf=Entry(f1aa,font=('arial',16,'bold'),textvariable=vada, bd=10,insertwidth=2, justify='left')
...
# --------------
lblFf=Label(f1aa,font=('arial',16,'bold'),text="chutney", bd=16, justify='left')
lblFf.grid(row=3,column=0)
txtFf=Entry(f1aa,font=('arial',16,'bold'),textvariable=vada, bd=10,insertwidth=2, justify='left')
txtFf.grid(row=3,column=1)
#===================================Payment Info==========================
...
# --------------
lblCcb=Label(f1ab,font=('arial',16,'bold'),text="Price of dosa", bd=16, justify='left')
lblCcb.grid(row=1,column=0)
txtCcb=Entry(f1ab,font=('arial',16,'bold'),textvariable=costdosa, bd=10,insertwidth=2, justify='left')
txtCcb.grid(row=1,column=1)
# --------------
lblCbb=Label(f1ab,font=('arial',16,'bold'),text="Price of idli", bd=16, justify='left')
lblCbb.grid(row=2,column=0)
txtCbb=Entry(f1ab,font=('arial',16,'bold'),textvariable=costidli, bd=10,insertwidth=2, justify='left')
txtCbb.grid(row=2,column=1)
# --------------
lblCff=Label(f1ab,font=('arial',16,'bold'),text="Price of vada", bd=16, justify='left')
lblCff.grid(row=3,column=0)
txtCff=Entry(f1ab,font=('arial',16,'bold'),textvariable=costvada, bd=10,insertwidth=2, justify='left')
...
# --------------
lblCsd=Label(f1ab,font=('arial',16,'bold'),text="Price of chutney", bd=16, justify='left')
lblCsd.grid(row=4,column=0)
txtCsd=Entry(f1ab,font=('arial',16,'bold'),textvariable=costsoftDrinks, bd=10,insertwidth=2, justify='left')
txtCsd.grid(row=4,column=1)
#==========================Total Payment Info======
